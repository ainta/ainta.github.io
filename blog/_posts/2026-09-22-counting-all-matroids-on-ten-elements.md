...
The rank-five extension calculation processes one representative of each of the 190214 isomorphism classes on nine elements. These computations run independently across cores. Each matroid has at most $\sum_{j=0}^{3}\binom9j=130$ flats of rank at most three and $\binom94=126$ hyperplanes.
...
Duality gives the counts for ranks 6–10 from ranks 4–0. The sum over all ranks is 3232000741644 matroids on ten elements up to isomorphism.
